 ...
 namespace App\Http\Controllers;
    ...
    class PageController extends BaseController {
        ...
        public function dashboard(Request $request) {
            ...
            return view('pages/dashboard', compact('kar', 'abs', 'cuti', 'title', 'username', 'profile', 'januari', 'jan_telat', 'february', 'feb_telat', 'maret', 'mar_telat', 'april', 'apr_telat', 'mei', 'mei_telat', 'juni', 'jun_telat', 'juli', 'jul_telat', 'agustus', 'aug_telat', 'september', 'sept_telat', 'oktober', 'oct_telat', 'november', 'nov_telat', 'desember', 'des_telat', 'jk'));
        }
        ...
        public function indexKaryawan(Request $request) {
            ...
            return view('pages/karyawan', ['karyawan' => $karyawan, 'new_id' => $new_id, 'title' => 'Data Karyawan' ,'username'=>$username, 'jk'=>$jk]);
        }
